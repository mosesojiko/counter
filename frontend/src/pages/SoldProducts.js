    ...
    return (
        <div>
            <div className="row top">
                <div className="col-1">
                    <h3>Total Amount: <strong>#</strong></h3>
                ...
                {
                    success && <MessageBox variant="success">Widthdraw request submitted.</MessageBox>
                }
                   <div>
                    <label htmlFor="accountname">Account Name</label>
                    <input type="text" id="acoountname" 
                ...
                <div>
                    <label />
                    <button className ="primary" type ="submit">Widthdraw</button>
                </div>
